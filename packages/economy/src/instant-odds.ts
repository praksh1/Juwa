 ...
 *
 * Exported because the engine's `diceRoll` divides by it to turn a draw of one
 * of ten thousand outcomes into the 0.00–99.99 the player sees. Two constants
 * for one grid is how a roll and its target end up on different scales.
 */
