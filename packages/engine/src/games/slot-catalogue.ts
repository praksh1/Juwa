...
export const SLOT_CATALOGUE: SlotDefinition[] = [
  ...
  { id: 'slot-emerald-nights', name: 'Emerald Nights', model: 'classic-20',
    theme: { primary: '#065F46', secondary: '#10B981', accent: '#A7F3D0' }, limits: DEFAULT_LIMITS },
  { id: 'slot-royal-flush', name: 'Royal Fortune', model: 'classic-20',
    theme: { primary: '#7F1D1D', secondary: '#DC2626', accent: '#FCA5A5' }, limits: DEFAULT_LIMITS },
  { id: 'slot-ocean-drift', name: 'Ocean Drift', model: 'classic-20',
    theme: { primary: '#0C4A6E', secondary: '#0EA5E9', accent: '#BAE6FD' }, limits: LOW_LIMITS },
  { id: 'slot-sunset-strip', name: 'Sunset Strip', model: 'classic-20',
    theme: { primary: '#9A3412', secondary: '#FB923C', accent: '#FED7AA' }, limits: DEFAULT_LIMITS },

  // ---------------------------------------------------------------- ten lines
  { id: 'slot-midnight-gold', name: 'Midnight Gold', model: 'lines-10',
    theme: { primary: '#1C1917', secondary: '#78716C', accent: '#FFC53D' }, limits: DEFAULT_LIMITS },
  { id: 'slot-neon-alley', name: 'Neon Alley', model: 'lines-10', tag: 'new',
    theme: { primary: '#4C1D95', secondary: '#2FE3D6', accent: '#FF3D8A' }, limits: DEFAULT_LIMITS },
  { id: 'slot-desert-mirage', name: 'Desert Mirage', model: 'lines-10',
    theme: { primary: '#78350F', secondary: '#D97706', accent: '#FDE68A' }, limits: DEFAULT_LIMITS },
  { id: 'slot-frost-peak', name: 'Frost Peak', model: 'lines-10',
    theme: { primary: '#1E3A8A', secondary: '#60A5FA', accent: '#DBEAFE' }, limits: LOW_LIMITS },
  { id: 'slot-jade-temple', name: 'Jade Temple', model: 'lines-10',
    theme: { primary: '#134E4A', secondary: '#14B8A6', accent: '#99F6E4' }, limits: DEFAULT_LIMITS },

  // -------------------------------------------------------------- twenty-five
  { id: 'slot-carnival-row', name: 'Carnival Row', model: 'lines-25',
    theme: { primary: '#831843', secondary: '#EC4899', accent: '#FBCFE8' }, limits: DEFAULT_LIMITS },
  { id: 'slot-jungle-run', name: 'Jungle Run', model: 'lines-25',
    theme: { primary: '#14532D', secondary: '#65A30D', accent: '#D9F99D' }, limits: DEFAULT_LIMITS },
  { id: 'slot-city-lights', name: 'City Lights', model: 'lines-25',
    theme: { primary: '#0F172A', secondary: '#38BDF8', accent: '#F1F5F9' }, limits: DEFAULT_LIMITS },
  { id: 'slot-spice-market', name: 'Spice Market', model: 'lines-25',
    theme: { primary: '#7C2D12', secondary: '#EA580C', accent: '#FFEDD5' }, limits: LOW_LIMITS },
  { id: 'slot-aurora-borealis', name: 'Aurora', model: 'lines-25',
    theme: { primary: '#312E81', secondary: '#818CF8', accent: '#C7D2FE' }, limits: DEFAULT_LIMITS },

  // ------------------------------------------------------------ high volatility
  { id: 'slot-dragons-hoard', name: "Dragon's Hoard", model: 'high-vol', tag: 'mega',
    theme: { primary: '#450A0A', secondary: '#B91C1C', accent: '#FFC53D' }, limits: HIGH_LIMITS },
  { id: 'slot-vault-breaker', name: 'Vault Breaker', model: 'high-vol',
    theme: { primary: '#18181B', secondary: '#52525B', accent: '#2FE3D6' }, limits: HIGH_LIMITS },
  { id: 'slot-supernova', name: 'Supernova', model: 'high-vol', tag: 'new',
    theme: { primary: '#1E1B4B', secondary: '#7C3AED', accent: '#F0ABFC' }, limits: DEFAULT_LIMITS },
  { id: 'slot-pharaohs-vault', name: "Pharaoh's Vault", model: 'high-vol',
    theme: { primary: '#422006', secondary: '#CA8A04', accent: '#FEF08A' }, limits: HIGH_LIMITS },
  { id: 'slot-storm-chaser', name: 'Storm Chaser', model: 'high-vol',
    theme: { primary: '#164E63', secondary: '#06B6D4', accent: '#CFFAFE' }, limits: DEFAULT_LIMITS },
